...
from src.models.components.net_swin import Dual_MTLR
    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.hparams['model'] == 'Dual':
            self.model = Dual_MTLR(hparams = self.hparams, embed_dim=96, patch_size=self.hparams['patch_size'], in_chans=self.hparams['in_channels'], img_size=(self.hparams["patch_z"], self.hparams["patch_xy"], self.hparams["patch_xy"]))
