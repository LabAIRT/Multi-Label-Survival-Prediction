...
class UNETR(nn.Module):
    ...
    def __init__(
        ...
        if hparams['n_dense'] ==2:
            self.fc_layers1 = nn.Sequential(nn.Linear(hparams['hidden_size'] , 256 * hparams['dense_factor']), 
                          nn.BatchNorm1d(256 * hparams['dense_factor']),
                          nn.ReLU(inplace=True), 
                          nn.Dropout(hparams['dropout']))
            

            # fc_layers2 = nn.Linear(256 * hparams['dense_factor'], 64 * hparams['dense_factor']),
            # nn.BatchNorm1d(64 * hparams['dense_factor']),
            # nn.ReLU(inplace=True),
            # nn.Dropout(hparams['dropout'])
            
            self.mtlr1 = nn.Sequential(nn.Linear(256 * hparams['dense_factor'], 64 * hparams['dense_factor']),
                                      nn.BatchNorm1d(64 * hparams['dense_factor']),
                                      nn.ReLU(inplace=True),
                                      nn.Dropout(hparams['dropout']),
                                      MTLR(64 * hparams['dense_factor'], hparams['time_bins']),)
            self.mtlr2 = nn.Sequential(nn.Linear(256 * hparams['dense_factor'], 64 * hparams['dense_factor']),
                                      nn.BatchNorm1d(64 * hparams['dense_factor']),
                                      nn.ReLU(inplace=True),
                                      nn.Dropout(hparams['dropout']),
                                      MTLR(64 * hparams['dense_factor'], hparams['time_bins']),)
            self.mtlr3 = nn.Sequential(nn.Linear(256 * hparams['dense_factor'], 64 * hparams['dense_factor']),
                                      nn.BatchNorm1d(64 * hparams['dense_factor']),
                                      nn.ReLU(inplace=True),
                                      nn.Dropout(hparams['dropout']),
                                      MTLR(64 * hparams['dense_factor'], hparams['time_bins']),)
            self.mtlr4 = nn.Sequential(nn.Linear(256 * hparams['dense_factor'], 64 * hparams['dense_factor']),
                                      nn.BatchNorm1d(64 * hparams['dense_factor']),
                                      nn.ReLU(inplace=True),
                                      nn.Dropout(hparams['dropout']),
                                      MTLR(64 * hparams['dense_factor'], hparams['time_bins']),)
            ...
            self.mtlr1 = MTLR(256 * hparams['dense_factor'], hparams['time_bins'])
            self.mtlr2 = MTLR(256 * hparams['dense_factor'], hparams['time_bins'])
            self.mtlr3 = MTLR(256 * hparams['dense_factor'], hparams['time_bins'])
            self.mtlr4 = MTLR(256 * hparams['dense_factor'], hparams['time_bins'])
