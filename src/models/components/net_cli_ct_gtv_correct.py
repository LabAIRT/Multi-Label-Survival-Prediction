# corrected the fully connect layer based on net_cli_ct_gtv.py
import imp
...
class UNETR(nn.Module):
    ...
    def __init__(
        ...
        if hparams['n_dense'] <=0:
            ...
            self.mtlr1 = MTLR(hparams['hidden_size'], hparams['time_bins'])
            self.mtlr2 = MTLR(hparams['hidden_size'], hparams['time_bins'])
            self.mtlr3 = MTLR(hparams['hidden_size'], hparams['time_bins'])
            self.mtlr4 = MTLR(hparams['hidden_size'], hparams['time_bins'])
            self.mtlr5 = MTLR(hparams['hidden_size'], hparams['time_bins'])

        elif hparams['n_dense'] ==1:
            self.fc_layers1 = nn.Sequential(nn.Linear(hparams['hidden_size'], 64*hparams['dense_factor']), 
            ...
            self.fc_layers1 = nn.Sequential(nn.Linear(hparams['hidden_size'] , 128*hparams['dense_factor']), 
